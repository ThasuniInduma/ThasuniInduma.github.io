      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 1024px) {
          .hero-section { grid-template-columns: 1fr !important; text-align: center; gap: 3rem !important; padding-top: 6rem !important; }
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <section className="hero-section" id="home" style={{
          ...
          <div className="hero-content" style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <p className={mounted ? 'd3' : ''} style={{ color: '#94a3b8', fontSize: '1.05rem', lineHeight: 1.7, marginBottom: '2rem', maxWidth: '600px', fontWeight: 300 }}>
            ...
            <div className={mounted ? 'd4' : ''} style={{ display: 'flex', gap: '0.7rem', flexWrap: 'wrap', alignItems: 'center' }}>
              <a href={cv} download className="btn-cv">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                </svg>
...
            </div>
        ...
        <footer style={{ 
          padding: '4rem 5% 2rem', 
          background: 'rgba(2, 9, 24, 0.5)', // Your original background preserved
          borderTop: '1px solid rgba(255,255,255,0.05)', // Your original border preserved
          backdropFilter: 'blur(10px)', // Optional: adds to the glass effect
          color: '#94a3b8' 
        }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ 
              ...
              {/* 3. RESOURCES/LEGAL COLUMN */}
              <div>
                <h3 style={{ fontSize: '0.75rem', fontWeight: 700, color: '#fff', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1.5rem' }}>Resources</h3>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {["Documentation", "Case Studies", "Style Guide", "Privacy Policy"].map(item => (
                    <li key={item} style={{ marginBottom: '0.75rem' }}>
                      <a href="#" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.85rem' }}>{item}</a>
                    </li>
                  ))}
                </ul>
              </div>
...
              </a>
            ...
            {/* BOTTOM BAR */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem', color: '#475569', fontSize: '0.8rem' }}>
